...
def crop_whitespace(image_path, output_path=None, margin_size='1cm', dpi=300):
    """Crop whitespace around images, adding optional margin."""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Convert PowerPoint slides to images and optionally crop whitespace.')
    parser.add_argument('-i', '--input_path', help='Path to the PowerPoint file.')
    ...
    powerpoint_to_images(args.input_path, args.output_path)
